...
const NavBar = () => {
    ...
    return (
        <div className='w-full min-h-[60px] bg-[#2A2A2A] text-white flex items-center justify-between px-4 lg:px-10'>

            {/* 🔹 Logo */}
            <div>
                <img
                    onClick={() => navigate('/')}
                    className='w-10 h-10 lg:w-14 lg:h-14 filter invert cursor-pointer'
            ...
            {/* 🔹 Menu */}
            <div className={`hidden md:flex gap-6 lg:gap-10 text-sm lg:text-base ${active ? "opacity-0 pointer-events-none" : ""}`}>
            ...
            <div className='flex items-center gap-4 lg:gap-6'>
                ...
                {/* 🔍 Search */}
                <div className={`flex items-center gap-2 rounded-full px-3 py-1 bg-[#1F1F21] transition-all duration-300 
